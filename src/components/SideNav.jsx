...
function SideNav() {
    ...
    return (
        <div className='relative'>
            <div className='mt-8 ml-10 dark:text-white absolute z-10 left-2 lg:hidden' onClick={handleMenuOpen}>
                <i className='bx bx-menu text-3xl' ></i>
            </div>
            <div
                className={`${isCollapsed ? 'w-24 duration-200 transition-all ease-in' : 'w-64 transition-all duration-200 ease-out'} h-screen bg-white border-r dark:bg-slate-900 dark:text-white ${!isMenuOpen && !isLargeView && 'hidden'} absolute z-50 lg:static lg:z-0 overflow-y-scroll`}
                id='sidebar'
            >
                <div className='flex justify-between items-center gap-20 pt-6 px-4 fixed bg-white'>
                    ...
                    </div>
                    {
                        isLargeView
                            ...
                            : <div className='lg:hidden ' onClick={handleMenuOpen}>
                                {
                                    isMenuOpen && <i className='bx bx-x text-2xl dark:text-white'></i>
                                }
                            </div>
                    }
                </div>
